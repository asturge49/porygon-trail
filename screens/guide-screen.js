...
(function() {
    ...
    const ABILITIES = [
        ...
        { name: 'Miracle', pokemon: 'Mew, Cleffa, Togepi, or Togetic', desc: 'Every day, a random bonus — a full heal, free food, money, items, bonus distance, or a Battle Star.' },
        { name: 'Sacred Flame', pokemon: 'Moltres, Entei, or Ho-Oh', desc: 'Your party eats no food at all.' },
